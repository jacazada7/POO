 class Heroi {
   ...
   defesa() {
     console.log(
       `${this.#nome} se defendeu ${this.#nivel * 2}  pontos de defesa!`
     );
   }
   receberDano(dano) {
     this.#vida -= dano;
 ...
 class Assassino extends Personagem {
   ...
   atacar() {
     console.log(
       `${this.nome} ataca silenciosamente com o dano adicional pela furtividade!`
     );
   }
 ...
 class Paladino extends Personagem {
   ...
   curar() {
     console.log(`${this.nome} use sua fe para curar a si mesmo ou aliado!`);
   }
 }
